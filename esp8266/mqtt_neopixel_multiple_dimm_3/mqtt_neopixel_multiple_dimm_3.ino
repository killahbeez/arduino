...
Adafruit_NeoPixel pixels_1 = Adafruit_NeoPixel(8, D1, NEO_GRB + NEO_KHZ800);
Adafruit_NeoPixel pixels_2 = Adafruit_NeoPixel(8, D2, NEO_GRB + NEO_KHZ800);
Adafruit_NeoPixel pixels_3 = Adafruit_NeoPixel(8, D3, NEO_GRB + NEO_KHZ800);
...
struct Topics neopixel_3_topic = {
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (strcmp(topic, neopixel_1_topic.command) == 0 || strcmp(topic, neopixel_2_topic.command) == 0 ||  strcmp(topic, neopixel_3_topic.command) == 0) {
    ...
    if ((String)arr[0] == "turn") { //if the command is turn
      ...
      if(strcmp(topic, neopixel_1_topic.command) == 0){
        setNeopixel(neopixel_1_topic,pixels_1,getCommand);
      }
      if(strcmp(topic, neopixel_2_topic.command) == 0){
        setNeopixel(neopixel_2_topic,pixels_2,getCommand);
      }
      if(strcmp(topic, neopixel_3_topic.command) == 0){
        setNeopixel(neopixel_3_topic,pixels_3,getCommand);
      }
      send_email = 1;
    }
  }
  ...
  if (strcmp(topic, neopixel_1_topic.commandDim) == 0 || strcmp(topic, neopixel_2_topic.commandDim) == 0 || strcmp(topic, neopixel_3_topic.commandDim) == 0) {
    ...
    if(strcmp(topic, neopixel_3_topic.commandDim) == 0){
      dimNeopixel(neopixel_3_topic,pixels_3,(char*)payload);
    }
  }
}
...
void setNeopixel(struct Topics neopixelTopic, Adafruit_NeoPixel& pixels, struct commands getCommand) {
