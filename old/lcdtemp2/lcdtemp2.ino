...
void setup() {
  ...
  DDRB |= (1 << PB4); // set PB4 (LAMP) as output)
  PORTB &= ~(1 << PB4); // PB4 LOW

  DDRD |= (1 << PD5); // set PD5 (FAN) as output)
  PORTD &= ~(1 << PD5); // PD5 LOW

  DDRD &= ~((1 << PD2) | (1 << PD4) | (1 << PD6) | (1 << PD7)); //set PD0 PD1 PD2 PD4  as INPUT
  PORTD |= (1 << PD2) | (1 << PD4) | (1 << PD6) | (1 << PD7); //set INPUT PULLUP resistor
...
void debouncePress() {
  volatile static uint8_t pins[] = {PD2, PD4, PD6, PD7};
